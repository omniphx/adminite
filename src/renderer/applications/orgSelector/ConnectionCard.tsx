...
import { Card, Row, Col, Modal, Input } from 'antd'
import { useDispatch } from 'react-redux'
import { onConnectionDelete, moveConnection } from '../../store/connections/actions'
      ...
      <Card bordered={false} style={{ background: 'transparent' }} >
        <Row justify='space-between'>
          ...
          <Col span={19}>
            <Meta
              title={renderTitle()}
              description={<div className='truncate'>{connection.username}</div>}
            />
          </Col>
