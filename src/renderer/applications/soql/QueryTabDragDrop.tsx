...
const QueryTabDragDrop: React.FC<IQueryTabDragDropProps> = React.memo((props: IQueryTabDragDropProps) => {
  const dispatch = useDispatch()
  const { tabId, children } = props

  const allIds: string[] = useSelector((state: ApplicationState) => state.queryTabsState.allIds)
